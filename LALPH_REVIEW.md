...
1. **Identify opportunities to improve code readability and maintainability.**
   - Prefer extracting helpers, subcomponents, modules, or local abstractions instead of allowing dense blocks of logic to grow.
...
Here are the task details for reference (do not implement, just review):
