...
export type {
  ...
  Api4InterAccountTransferBatchParams as ManagerInterAccountTransferBatchParams,
  ...
  BusinessObjectsResourceOfInterAccountTransfer as ManagerInterAccountTransferBatch,
  ...
  ItemOfInterAccountTransfer as ManagerInterAccountTransferItem,
  ItemOfPayment as ManagerPaymentItem,
  ItemOfReceipt as ManagerReceiptItem,
  InterAccountTransfer1 as ManagerInterAccountTransfer,
